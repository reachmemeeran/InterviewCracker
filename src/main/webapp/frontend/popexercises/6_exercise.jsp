...
<body>
	...
	<div class="card one" style="width:92%; height:600px;margin-bottom:30px;">
		<h3 class="title" style="margin-left:25%;margin-top:20px;">6. Week 2: Functions and Parameters - Lesson 3: The Flow of Execution</h3>
		<div class="card one" style="width:22%;margin-top:-1px;margin-right:-1px;margin-bottom:-1px;margin-left:15px;">
			...
			<br> The Number 3 is divisble by 3? YES(true) <br>
The Number 3 is divisble by 3 or 5? YES(true)  <br>
			<br>
		</div>
