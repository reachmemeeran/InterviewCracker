...
<head>
<meta charset="UTF-8">
<title>Coding Challenge Certificate</title>
...
<div class="cert-container">
	...
	<div id="print" class="card one" style="width:90%; height:90%; box-shadow:0px 0px 0px 10px grey inset;">
		...
		<div style="text-align: left;margin-top: 2%; color: gray">
			...
			<c:if test="${solvedStudentCode==20}">
				<p class="certcontent">for successfully completing all 20 Interview coding Questions in the Coding Challenge module.</p>
				
			</c:if>
			<c:if test="${solvedStudentCode!=20}">
				<p class="certcontent">for successfully completing <b> ${solvedStudentCode} out of 20 Interview coding Questions </b> and ranked <b> Number - ${codeRank}</b> in the Coding Challenge module.</p>
