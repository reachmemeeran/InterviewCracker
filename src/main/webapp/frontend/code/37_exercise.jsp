...
<body>
	...
	<jsp:directive.include file="../header.jsp" />
		...
		<h3 class="title" style="margin-left:40%;margin-top:20px;">Medium-6: Regular Expression - Part-2</h3>
		...
		<div class="card one" style="width:100%;margin-top:-1px;margin-right:-1px;margin-bottom:-1px;margin-left:15px;border-radius:0px;min-height:30px;background:#000;">
				...
				<pre>
<p style="font-weight: bold;color:green;">Question:</p>Remove duplicate words in a sentence. For Example: the sentence - 
...
&nbsp;
<p style="font-weight: bold;color:green;">Expected Output:</p>I live in this world
</pre>
			</div>
