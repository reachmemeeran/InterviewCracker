...
<body>
	...
	<jsp:directive.include file="../header.jsp" />
		...
		<h3 class="title" style="margin-left:40%;margin-top:20px;">Medium-3: Create a Thread by Extending the Thread class</h3>
		...
		<div class="card one" style="width:100%;margin-top:-1px;margin-right:-1px;margin-bottom:-1px;margin-left:15px;border-radius:0px;min-height:30px;background:#000;">
				...
				<pre>
<p style="font-weight: bold;color:green;">Question:</p>Complete the program to extend the thread class and correct the 
compilation errors.
...
<p style="font-weight: bold;color:cyan;">Extending the Thread class:</p>Create a new class that extends Thread class using the two simple steps. 
