...
@WebServlet("/admin/delete_codeComplexity")
public class DeleteCodeComplexityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public DeleteCodeComplexityServlet() {
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
			throws ServletException, IOException {
		CodeComplexityServices codeComplexityServices = new CodeComplexityServices(request, response);
		codeComplexityServices.deleteCodeComplexity();
	}
