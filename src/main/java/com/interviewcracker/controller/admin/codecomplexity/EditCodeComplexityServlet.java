...
@WebServlet("/admin/edit_codeComplexity")
public class EditCodeComplexityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public EditCodeComplexityServlet() {
    }

    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
    		throws ServletException, IOException {
    	CodeComplexityServices codeComplexityServices = new CodeComplexityServices(request, response);
    	codeComplexityServices.editCodeComplexity();
	}
